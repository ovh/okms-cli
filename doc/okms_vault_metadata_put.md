## okms vault metadata put

Create a blank path in the key-value store or to update path configuration for a specified path.

```
okms vault metadata put PATH [flags]
```
