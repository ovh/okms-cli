...
Retrieves the value from KMS's key-value store at the given key name

```
okms vault get PATH [flags]
```
...
```
  -h, --help             help for get
      --version uint32   If passed, the value at the version number will be returned
```
