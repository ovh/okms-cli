## okms secrets version update

Update a secret version

```
okms secrets version update  PATH --version VERSION --state STATE [flags]
```
...
```
  -h, --help                               help for update
      --state active|deactivated|deleted   State of the secret version. Value must be in active|deactivated|deleted
